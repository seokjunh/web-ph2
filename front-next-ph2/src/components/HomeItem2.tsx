...
const HomeItem2 = () => {
  return (
    <div className="h-[calc(100vh-6.25rem)] bg-white py-12">
      <div className="relative px-6 text-center">
        <div className="text-3xl font-extrabold text-[#303030]">About Us</div>
        ...
        <div className="mx-auto mt-6 max-w-4xl space-y-4 text-gray-700 sm:text-lg md:text-xl">
          ...
          <div>
            점점 복잡해지고 다양한 데이터를 표준화된 방식으로 연결합니다. 이를
            통해, 더 지능적이고 편리한 세상을 만들어가는 혁신적인 솔루션을
            개발하고 있습니다.
          </div>
          <div>
            자체 개발 특허 솔루션을 보유한 스마트팩토리 선도 기업으로서, 4차
            산업혁명 시대 제조 산업의 혁신을 이끌며 고객의 비즈니스 성장을
            지원합니다.
          </div>
        </div>
